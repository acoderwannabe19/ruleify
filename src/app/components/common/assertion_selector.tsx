...
export default function AssertionSelector(
  {isDisabled, obj, handleOperatorSelection, handleValueSelection} : 
   ...
   <div className="row">
     <div className="col">
              <select className="form-select"  onChange={handleOperatorSelection} disabled={isDisabled} name="pets" id="pet-select">
                <option disabled={obj.isAssertionMandatory} > None </option>
                <option> &gt; </option>
                <option> &gt;= </option>
                <option> &lt; </option>
                <option> &lt;= </option>
            ...
            <div className="col">
              <input onChange={handleValueSelection} disabled={isDisabled || obj.isValueDisabled}  type="number" className="form-control" ></input>
            </div>
   </div>
